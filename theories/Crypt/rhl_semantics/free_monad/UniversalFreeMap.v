...
Set Warnings "notation-overridden".
From SSProve.Crypt Require Import disc FreeProbProg ChoiceAsOrd.
...
Section ForgetFromRmonToOpar.
  ...
  Definition forgOps : Type := {A : count1Type & T A}.
...
Section UnivFreeMap.
  ...
  Context {sigma_ops : Type} {sigma_ar : sigma_ops -> count1Type}.
  ...
  Fixpoint outOfFree0 (A:count1Type) (tree : Free_sigma A) {struct tree} : T A.
  Proof.
