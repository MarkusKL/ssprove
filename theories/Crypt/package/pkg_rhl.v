...
Lemma r_uniform_bij :
  ∀ {A₀ A₁ : ord_choiceType} F G pre post f
...
Section Uniform_prod.
  ...
  Proof.
    ...
    rewrite psumZ.
    2: unshelve eapply @r_nonneg; apply (a, b).
  ...
  Proof.
    ...
    with (@Uniform_F i heap_choiceType).
